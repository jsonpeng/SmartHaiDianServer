/* sockjs-client v1.0.0 | http://sockjs.org | MIT license */ ! function(t) {
	...
	return function e(t, n, r) {
						...
						n.once("message", function(t) {
							if (t) {
								...
								try {
									...
									return e.emit("finish"), void e.close()
								}
								var i = n[0],
									o = n[1];
								e.emit("finish", i, o)
		...
		12: [function(t, e) {
			...
			var r = t("events").EventEmitter,
				...
				c = t("./info-iframe"),
				f = t("./info-ajax");
			i(n, r), n._getReceiver = function(t, e) {
				...
				var r = this,
					i = o.addPath(t, "/info");
				this.xo = n._getReceiver(i, e), this.timeoutRef = setTimeout(function() {
		...
		14: [function(t, e) {
			(function(n) {
				...
				function r(t, e, n) {
					...
					b.call(this), this.readyState = r.CONNECTING, this.extensions = "", this.protocol = "", n = n || {}, n.protocols_whitelist && m.warn("'protocols_whitelist' is DEPRECATED. Use 'transports' instead."), this._transportsWhitelist = n.transports, this._server = n.server || l.numberString(1e3);
					var i = new s(t);
					...
					if ("https" === g.protocol && !o) throw new Error("SecurityError: An insecure SockJS connection may not be initiated from a page loaded over HTTPS");
					e ? Array.isArray(e) || (e = [e]) : e = [];
					var a = e.sort();
					a.forEach(function(t, e) {
						if (!t) throw new SyntaxError("The protocols entry '" + t + "' is invalid.");
						if (e < a.length - 1 && t === a[e + 1]) throw new SyntaxError("The protocols entry '" + t + "' is duplicated.")
					});
					var u = f.getOrigin(g.href);
					this._origin = u ? u.toLowerCase() : null, i.set("pathname", i.pathname.replace(/\/+$/, "")), this.url = i.href, this._urlInfo = {
