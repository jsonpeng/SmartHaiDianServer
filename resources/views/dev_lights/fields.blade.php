    ...
    {!! Form::label('image', '设备图片:') !!}
         <div class="form-group">
                ...
                <div class="input-append">
                    ...
                    <img src="@if(isset($devLight)) {{$devLight->image}} @endif" style="max-width: 100%; max-height: 150px; display: block;">
                </div>
    ...
    {!! Form::label('icon', '设备icon:') !!}
         <div class="form-group">
                ...
                <div class="input-append">
                    ...
                    <img src="@if(isset($devLight)) {{$devLight->icon}} @endif" style="max-width: 100%; max-height: 150px; display: block;">
                </div>
